...
def show_data_attributes(inputs, labels, attribute_names, class_names):
    ...
    for i in range(n_attributes):
        for j in range(i + 1, n_attributes):
            ...
            plot_handle = figure_handle.add_subplot(
                n_plot_rows, n_plot_columns, plot_index
            )
...
def show_data_images(
    images, labels=None, predictions=None, class_names=None, blocking=True
):
    # Create a figure
