...
def flowers_trained_cnn(
    ...
    if load_from_file and os.path.isfile(net_save_name):
        ...
        # Conv layer 8: 3x3 window, 512 filters

        # # Conv layer 9: 3x3 window, 512 filters
        ...
        # net.add(
        #     keras.layers.Dense(
        #         units=1000, activation="relu", kernel_regularizer=reg_wdecay
        #     )
        # )

        net.add(
            keras.layers.Dense(
                units=100, activation="relu", kernel_regularizer=reg_wdecay
            )
        )
        ...
        # net.add(
        #     keras.layers.Dense(
        #         units=4096, activation="relu", kernel_regularizer=reg_wdecay
        #     )
        # )
